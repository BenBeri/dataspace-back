...
export class PostgresConnection extends BaseDatabaseConnection {
  ...
  constructor(
    ...
    super(workspaceId, repositoryId, dataSourceId, DataSourceType.POSTGRES, config);
  }
  ...
  async executeTransaction<T = any>(
    ...
    try {
      ...
      throw new BadRequestException(`PostgreSQL transaction failed: ${error.message}`);
    }
  }
  ...
  async getServerVersion(): Promise<string> {
    const result = await this.execute<Array<{ version: string }>>('SELECT version()');
